...
typedef enum WbMswConfigParameter_s
{
	WB_MSW_CONFIG_PARAMETER_FIRST = 64,

	// Temperature channel settings
	WB_MSW_CONFIG_PARAMETER_TEMPERATURE_REPORT_THRESHOLD = WB_MSW_CONFIG_PARAMETER_FIRST,
	...
	WB_MSW_CONFIG_PARAMETER_CO2_AUTO,
