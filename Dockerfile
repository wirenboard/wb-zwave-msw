...
RUN apt-get update && apt-get install -y make unzip wget && \
    wget -qO - http://rus.z-wave.me/files/z-uno/g2/tc/arm-none-eabi-gcc-7_2_4-linux64.tar.gz | tar -xz -C / && \
    wget -qO - http://rus.z-wave.me/files/z-uno/g2/tc/libclang_11_0_1-linux64.tar.gz | tar -xz -C / && \
    wget -qO - https://github.com/Z-Wave-Me/Z-Uno-G2-Core/archive/refs/tags/ZUNO_CORE_BETA_03_00_12_B5.tar.gz | tar -xz -C / && \
    mv /Z-Uno-G2-Core-ZUNO_CORE_BETA_03_00_12_B5 /Z-Uno-G2-Core && \
