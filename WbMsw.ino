        ...
        switch (_channel[channel].type) {
            case WB_MSW_CHANNEL_TYPE_TEMPERATURE:
                zunoAppendChannelHandler(channel,
                                         ...
                                         (void*)&_channel[channel].temperature);
                break;
            case WB_MSW_CHANNEL_TYPE_HUMIDITY:
                zunoAppendChannelHandler(channel,
                                         WB_MSW_INPUT_REG_HUMIDITY_VALUE_SIZE,
                                         CHANNEL_HANDLER_SINGLE_VALUEMAPPER,
                                         (void*)&_channel[channel].humidity);
                break;
            case WB_MSW_CHANNEL_TYPE_LUMEN:
                zunoAppendChannelHandler(channel,
                                         WB_MSW_INPUT_REG_LUMEN_VALUE_SIZE,
            ...
            case WB_MSW_CHANNEL_TYPE_NOISE_LEVEL:
                zunoAppendChannelHandler(channel,
                                         WB_MSW_INPUT_REG_NOISE_LEVEL_VALUE_SIZE,
                                         CHANNEL_HANDLER_SINGLE_VALUEMAPPER,
                                         (void*)&_channel[channel].noise_level);
                break;
            case WB_MSW_CHANNEL_TYPE_MOTION:
                zunoAppendChannelHandler(channel,
                                         1,
...
#ifdef LOGGING_DBG
                LOGGING_UART.print("*** ERROR Can't open port for fast modbus scan!\n");
#endif
                delay(1000);
            }
            break;
...
#ifdef LOGGING_DBG
                LOGGING_UART.print("*** ERROR Fast modbus scan ends unsuccessfully!\n");
#endif
                ZUnoState = TZUnoState::ZUNO_SCAN_ADDRESS_INITIALIZE;
                delay(1000);
            }
...
#ifdef LOGGING_DBG
                LOGGING_UART.print("*** ERROR Can't open modbus port!\n");
#endif
                ZUnoState = TZUnoState::ZUNO_SCAN_ADDRESS_INITIALIZE;
                delay(1000);
            }
...
#ifdef LOGGING_DBG
                LOGGING_UART.print("*** ERROR WB sensor not responds!\n");
#endif
                ZUnoState = TZUnoState::ZUNO_SCAN_ADDRESS_INITIALIZE;
                delay(1000);
            }
...
#ifdef LOGGING_DBG
                LOGGING_UART.print("*** ERROR WB sensor doesn't support any kind of sensors!\n");
#endif
                delay(1000);
            }
            break;
